...
export default function AdminDashboardIndex({ stats, products, orders }: Props) {
  return (
    <AdminLayout>
      <div className="space-y-8">
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            ...
            <Link href="/admin/orders" className="text-sm text-indigo-600 hover:text-indigo-800 font-medium">
              View all →
            </Link>
          </div>
          <div className="overflow-x-auto">
